...
class DERGenBase:
    ...
    def _init_variables(self):
        ...
        self.mass_link = self.r_len / self.r_pieces
    ...
    def _write_mb_geom(self, f, i_section):
        if i_section == 0 or i_section == self.r_pieces-1:
            f.write(
                ...
                + '<geom name="r_link{}_geom" quat="0.707 0. 0.707 0." type="{}" size="{:1.4f} {:1.4f}" mass="{}" rgba=".1 .2 .1 1" friction="1 0.005 0.0001" solref="{}" conaffinity="1" contype="1"/>\n'.format(
                    i_section + 1,
                    self.rope_type,
                    self.cap_size[0],
                    self.cap_size[1],
            ...
            f.write(
                self.curr_tab*self.t
                + '<geom name="r_link{}_geom" quat="0.707 0. 0.707 0." type="{}" size="{:1.4f} {:1.4f}" mass="{}" rgba=".1 .2 .1 1" friction="1 0.005 0.0001" solref="{}"/>\n'.format(
                    i_section + 1,
                    self.rope_type,
                    self.cap_size[0],
                    self.cap_size[1],
    ...
    def _write_equality(self, f):
        ...
        if self.both_fixed:
            if self.fix_rob:
                f.write(
                    self.t + "   <weld body1='right_hand' body2='r_joint{}_body' solref='0.004 1' relpose='0 0 {} 0.5 0.5 -0.5 0.5'/>\n".format(
                        self.r_pieces,
    ...
    def _write_anchorbox(self):
        ...
        with open(self.obj_path2, "w+") as f:
            ...
            if not self.fix_rob:
                ...
                f.write(
                    self.curr_tab*self.t
                    + '<geom name="fixedbox1" type="box" mass="1" size="{:1.4f} {:1.4f} {:1.4f}" conaffinity="0" contype="0" rgba=".8 .2 .1 0.3" friction="1 0.005 0.0001"/>\n'.format(
                        self.box_size[0],
                        self.box_size[1],
                        self.box_size[2],
                    )
...
class DERGen_eq1D(DERGenBase):
    ...
    def _write_mainbody(self):
        with open(self.obj_path, "w+") as f:
            ...
            f.write(
                (self.curr_tab+1)*self.t
                + '<geom conaffinity="0" contype="0" name="r_joint{}_geom" type="sphere" size="{} {} {}" mass="{}" rgba=".8 .2 .1 1" friction="1 0.005 0.0001"/>\n'.format(
                    0,
                    self.joint_size,
                    self.joint_size,
                    self.joint_size,
    ...
    def _write_equality(self, f):
        ...
        if self.both_fixed:
            if self.fix_rob:
                f.write(
                    self.t + "   <weld body1='right_hand' body2='r_joint{}_body' solref='0.004 1' relpose='0 0 {} 0 1 0 0'/>\n".format(
                        self.r_pieces,
                ...
                f.write(
                    self.t + "   <weld body1='anchor_box' body2='r_joint{}_body' solref='0.004 1' relpose='{} 0 0 1 0 0 0'/>\n".format(
                        self.r_pieces,
                        self.box_size[1],
                    )
                )
